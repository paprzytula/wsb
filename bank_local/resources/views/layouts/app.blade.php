...
<head>
    ...
    <title>{{ config('app.name', 'WSB_BANK') }}</title>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm border-bottom">
            <div class="container">
                ...
                <a class="navbar-brand font-weight-bold" href="{{ url('/') }}">
                    {{ strtoupper(config('app.name', 'WSB_BANK')) }}
                </a>
            </div>
        </nav>
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item {{ \Request::route()->getName()=='home' ? 'active': '' }}">
                            ...
                            <i class="fas fa-home"></i>
                                Pulpit <span class="sr-only">(current)</span>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('admin.users.index') }}">Zarządzanie Użytkownikami</a>
                        </li>
                    </ul>
