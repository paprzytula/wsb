                ...
                <div class="card-body">
                    <form action="/questionnaires" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <small id="titleHelp" class="form-text text-muted">Give your questuionnaire a title that
                        ...
                        <div class="form-group">
                            ...
                            <small id="purposeHelp" class="form-text text-muted">Giving purpose will increase
                                responses.</small>
                            @error('purpose')
                            <small class="text-danger">{{ $message }}</small>
                            @enderror
